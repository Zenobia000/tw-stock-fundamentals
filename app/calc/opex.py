...
def effective_tax_rate(pretax_income: float | None, net_income: float | None) -> float | None:
    """有效稅率 = (稅前淨利 − 稅後淨利) / 稅前淨利。"""
...
def operating_cycle_days(ar_days: float | None, inventory_days: float | None) -> float | None:
