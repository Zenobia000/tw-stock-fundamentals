from app.db.capital_reductions import CapitalReduction, get_capital_reduction, upsert_capital_reduction
...
def test_capital_reduction_roundtrip_and_missing_returns_none(tmp_path):
    ...
    entry = CapitalReduction(name="某股票", code="1234", resume_date="2026-05-01", adjust_factor=0.6)
